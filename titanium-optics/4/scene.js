...
const skyMaterial = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./titanium-optics/sky.png'), side: THREE.BackSide });
const sky = new THREE.Mesh(skyGeometry, skyMaterial);
scene.add(sky);

// Plane
const floorGeometry = new THREE.PlaneGeometry( 0.3, 0.3 );
const floorMaterial = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./titanium-optics/floor.png'), transparent: true});
